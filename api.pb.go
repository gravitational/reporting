...
func (*GRPCEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_b926c21291ce7e85, []int{0}
}
...
func (*GRPCEvents) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_b926c21291ce7e85, []int{1}
}
...
func init() { proto.RegisterFile("api.proto", fileDescriptor_api_b926c21291ce7e85) }

var fileDescriptor_api_b926c21291ce7e85 = []byte{
